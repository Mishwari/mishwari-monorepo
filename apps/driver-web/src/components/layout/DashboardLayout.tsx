...
import { AppShell, Sidebar, Header, MobileMenu, LogoutButton, UserDropdownMenu } from '@mishwari/ui-web';
...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const { profile, isAuthenticated } = useSelector((state: AppState) => state.auth);
  ...
  const navItems = useMemo(() => {
    console.log('[DashboardLayout] Full auth state:', { profile, isAuthenticated });
