  ...
  return (
    <div
      ...
      <button
        ...
        {userName ? userName.substring(0, 2).toUpperCase() : (phoneNumber ? phoneNumber.substring(phoneNumber.length - 2) : '##')}
      </button>
          ...
          {!userName && onCompleteProfile && (
            <div className='p-2 border-b border-slate-50'>
              <button
                ...
                className='w-full flex items-center gap-2 p-3 rounded-xl bg-brand-primary text-white hover:bg-brand-primary-dark transition-colors justify-center'>
                <PencilIcon className='w-4 h-4' />
                <span className='text-xs font-bold'>أكمل ملفك الشخصي</span>
              </button>
            </div>
          )}
